...
class Usuario(db.Model):
    ...
    # Privacidad
    privacidad_seguir = db.Column(db.String(20), default="todos")  # todos | amigos
    privacidad_recetas = db.Column(
        db.String(20), default="seguidores"
    )  # seguidores | privado
    privacidad_interactuar = db.Column(
        db.String(20), default="todos"
    )  # todos | seguidores
    privacidad_likes = db.Column(
        db.String(20), default="todos"
    )  # todos | amigos | privado
    privacidad_seguidores = db.Column(
        db.String(20), default="todos"
    )  # todos | amigos | privado
